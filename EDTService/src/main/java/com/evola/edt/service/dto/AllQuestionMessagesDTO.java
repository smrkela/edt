...
public class AllQuestionMessagesDTO {
	
	private List<AllQuestionMessageDTO> messages;
	...
	public List<AllQuestionMessageDTO> getMessages() {
		return messages;
	}

	public void setMessages(List<AllQuestionMessageDTO> messages) {
