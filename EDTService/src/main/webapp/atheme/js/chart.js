...
var daire = [3];
    ...
    jQuery('#heart .legendLabel').addClass('animated pulse');
*/
    ...
    jQuery.plot(jQuery("#bernoilli"), [
        {data:bernoulli,label:'Lemniscate of Bernoulli'}
		], {
			lines: {
				show:true,
				fill:true
